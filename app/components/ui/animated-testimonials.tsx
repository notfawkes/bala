      ...
      <div className="relative grid grid-cols-1 md:grid-cols-2 gap-20">
        ...
        <div className="flex justify-between flex-col py-4">
          ...
          <div className="flex gap-4 pt-12 md:pt-0">
            <button onClick={handlePrev} className="h-7 w-7 rounded-full bg-secondary flex items-center justify-center group/button">
              <ChevronLeft className="h-5 w-5 text-foreground group-hover/button:rotate-12 transition-transform duration-300" />
            </button>
            <button onClick={handleNext} className="h-7 w-7 rounded-full bg-secondary flex items-center justify-center group/button">
